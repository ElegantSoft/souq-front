<template>
     <div class="form-container row container">
          ...
          <p v-if="!isChild">نوع القسم: <span style="color:#e678a1">قسم رئيسى</span></p>
          <p v-if="isChild">نوع القسم: <span style="color:#e678a1">قسم فرعى</span></p>
          <div class="col-sm-12">
               <div class="form-group">
          ...
          <br>
          <div class="col-sm-6">
               <img :src="'/uploads/cat-thumbs/'+newCategory.image" v-if="newCategory.image" class="slider" alt="">
          </div>
          <div class="col-sm-12">

          <p class="alert alert-danger p-2" v-if="extErr">يجب ان تكون الملفات المرفوعة بصيغة png, jpeg, jpg</p>
          <div class="progress m-3" v-if="uploadPercentage > 0">
               <div class="progress-bar" role="progressbar" :style="{'width': uploadPercentage+'%'}" aria-valuenow="25"
                    aria-valuemin="0" aria-valuemax="100">{{uploadPercentage + '%'}}
               </div>
          </div>
          ...
          <div class="col-sm-12">
               <div class="form-group">
                    <button @click="addCategory" style="width:100%" type="button" class=" mt-3  btn btn-md btn-info">اضافة القسم</button>
               </div>
          </div>
          <div class="col-sm-12">
