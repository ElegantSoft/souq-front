...
Vue.component('edit-category', require('./components/admin/categories/edit.vue').default);
...
Vue.component('index-product', require('./components/admin/product/IndexProduct.vue').default);
Vue.component('vue-pagination', require('./components/reuseable/VuePagination.vue').default);

//cards
Vue.component('create-card-category', require('./components/admin/cards/categories/create.vue').default);
Vue.component('create-card-card', require('./components/admin/cards/cards/create.vue').default);
Vue.component('index-card-category', require('./components/admin/cards/categories/index.vue').default);
Vue.component('index-card-card', require('./components/admin/cards/cards/index.vue').default);
